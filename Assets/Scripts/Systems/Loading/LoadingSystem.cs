...
namespace AMVC.Systems.Loading
{
    public class LoadingSystem : AppSystem
    {
        ...
        [Header("DataBase Parameters")] [SerializeField]
        private int timeOut;
        ...
        public void StartLoading()
        {
            ...
            //create Ships command

            var shipsCommand = new LoadingCommand<ShipModel>(ApiList.ships);
            shipsCommand.OnComplete += result => _models.ships = result;
            _invoker.AddCommand(shipsCommand);
